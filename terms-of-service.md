...
These Terms of Service (“Terms”) govern your access to and use of the ReSell mobile application and related services (the “Service”). By creating an account, accessing, or using the Service, you agree to these Terms.
...
You must be at least **18 years old** to use ReSell. By using the Service, you represent that you are 18 or older and have the legal capacity to enter into these Terms.
...
You may not list, sell, request, or facilitate transactions involving:
...
- **Alcohol**
- **Prescription medication** and controlled pharmaceuticals
...
### 5.4 Other restricted categories
- Anything that violates local, state, or federal law
- Any listings that present serious safety risks, as determined by ReSell

**Important:** Laws and restrictions vary by jurisdiction. You are responsible for ensuring your listings and transactions are legal where you live and where the transaction occurs.
...
- Use safe payment methods and never pay in advance to unknown parties.
- Trust your instincts; if something seems suspicious, do not proceed.
...
THE SERVICE IS PROVIDED “AS IS” AND “AS AVAILABLE.” TO THE MAXIMUM EXTENT PERMITTED BY LAW, RESELL DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, RESELL WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, DATA, OR GOODWILL, ARISING FROM OR RELATED TO YOUR USE OF THE SERVICE.

RESELL’S TOTAL LIABILITY FOR ANY CLAIM ARISING OUT OF OR RELATING TO THE SERVICE WILL NOT EXCEED THE GREATER OF:
- USD $100, OR
- THE AMOUNT YOU PAID RESELL (IF ANY) IN THE 12 MONTHS BEFORE THE CLAIM.

Some jurisdictions do not allow certain limitations, so some of the above may not apply to you.

## 12. Indemnification

You agree to defend, indemnify, and hold harmless ReSell and its operator from and against any claims, liabilities, damages, losses, and expenses (including attorneys’ fees) arising out of or related to:
...
We may update these Terms from time to time. We will update the effective date. Continued use after changes means you accept the updated Terms.
